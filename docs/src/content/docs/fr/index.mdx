...
hero:
  ...
  actions:
    ...
    - text: Aller au dernier Challenge
      link: /fr/challenges/forms/62-crossfield-validation-signal-form/
      icon: rocket
...
<CardGrid>
<Card title="62 Défis">
    Ce répertoire rassemble 62 Défis liés à <b>Angular</b>, <b>Nx</b>, <b>RxJS</b>, <b>Ngrx</b> et <b>Typescript</b>. Ces défis portent sur des problèmes réels ou des fonctionnalités spécifiques pour améliorer vos compétences.
</Card>
