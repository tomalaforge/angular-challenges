...
hero:
  ...
  actions:
    ...
    - text: Aller au dernier Challenge
      link: /fr/challenges/forms/61-simplest-signal-form/
      icon: rocket
...
<CardGrid>
<Card title="61 Défis">
    Ce répertoire rassemble 61 Défis liés à <b>Angular</b>, <b>Nx</b>, <b>RxJS</b>, <b>Ngrx</b> et <b>Typescript</b>. Ces défis portent sur des problèmes réels ou des fonctionnalités spécifiques pour améliorer vos compétences.
</Card>
