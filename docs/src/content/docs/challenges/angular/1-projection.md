...
To learn about <b>ngTemplateOutlet</b>, you can find the API documentation [here (old docs)](https://angular.io/api/common/NgTemplateOutlet) and [here (new docs)](https://angular.dev/api/common/NgTemplateOutlet) along with some basic examples.
