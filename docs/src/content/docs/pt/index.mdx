...
hero:
  ...
  actions:
    ...
    - text: Ir para o desafio mais recente
      link: /pt/challenges/forms/62-crossfield-validation-signal-form/
      icon: rocket
...
<CardGrid>
  <Card title="62 Desafios">
    Este repositório possui 62 Desafios relacionados a <b>Angular</b>, <b>Nx</b>, <b>RxJS</b>,
