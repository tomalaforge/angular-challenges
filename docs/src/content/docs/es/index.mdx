...
hero:
  ...
  actions:
    ...
    - text: Ir al Desafío más reciente
      link: /es/challenges/forms/61-simplest-signal-form/
      icon: rocket
...
<CardGrid>
<Card title="61 Desafíos">
  Este repositorio contiene 61 Desafíos relacionados con <b>Angular</b>, <b>Nx</b>, <b>RxJS</b>, <b>Ngrx</b> y <b>Typescript</b>.
