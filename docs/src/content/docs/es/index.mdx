...
hero:
  ...
  actions:
    ...
    - text: Ir al Desafío más reciente
      link: /es/challenges/forms/62-crossfield-validation-signal-form/
      icon: rocket
...
<CardGrid>
<Card title="62 Desafíos">
  Este repositorio contiene 62 Desafíos relacionados con <b>Angular</b>, <b>Nx</b>, <b>RxJS</b>, <b>Ngrx</b> y <b>Typescript</b>.
