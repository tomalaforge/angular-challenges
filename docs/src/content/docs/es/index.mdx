...
hero:
  ...
  actions:
    ...
    - text: Ir al Desafío más reciente
      link: /es/challenges/forms/63-custom-forms/
      icon: rocket
...
<CardGrid>
<Card title="63 Desafíos">
  Este repositorio contiene 63 Desafíos relacionados con <b>Angular</b>, <b>Nx</b>, <b>RxJS</b>, <b>Ngrx</b> y <b>Typescript</b>.
