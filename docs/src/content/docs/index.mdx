...
hero:
  ...
  actions:
    ...
    - text: Go to the latest Challenge
      link: /challenges/forms/61-simplest-signal-form/
      icon: rocket
    - text: Give a star
...
<CardGrid>
<Card title="61 Challenges">
    This repository gathers 61 Challenges related to <b>Angular</b>, <b>Nx</b>, <b>RxJS</b>, <b>Ngrx</b> and <b>Typescript</b>.
