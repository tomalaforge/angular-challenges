...
hero:
  ...
  actions:
    ...
    - text: Go to the latest Challenge
      link: /challenges/forms/62-crossfield-validation-signal-form/
      icon: rocket
    - text: Give a star
...
<CardGrid>
<Card title="62 Challenges">
    This repository gathers 62 Challenges related to <b>Angular</b>, <b>Nx</b>, <b>RxJS</b>, <b>Ngrx</b> and <b>Typescript</b>.
