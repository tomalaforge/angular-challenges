...
import { ContactFormWithInputFormComponent } from './contact-form/contact-form.component';
import {
  contactSchema,
  ContactValue,
  initialContactValue,
...
@Component({
  selector: 'app-simple-registration-form',
  templateUrl: './simple-registration-form.component.html',
  imports: [
    JsonPipe,
    ContactFormWithInputFormComponent,
    FormRoot,
    FormField,
    ValidationComponent,
    EmailFormWithInputFormComponent,
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export default class SimpleRegistrationFormComponent {
