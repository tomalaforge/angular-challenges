...
import SimpleRegistrationFormComponent from './simple-registration-form.component';

describe('SimpleRegistrationFormComponent', () => {
  beforeEach(async () => {
    TestBed.createComponent(SimpleRegistrationFormComponent);
  });
