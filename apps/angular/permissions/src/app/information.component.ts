...
import { AdminAuthDirective } from './commons/admin-auth.directive';
import { RoleAuthDirective } from './commons/role-auth.directive';
import { UserStore } from './user.store';

@Component({
  selector: 'app-information',
  standalone: true,
  imports: [CommonModule, RoleAuthDirective, AdminAuthDirective],
  template: `
