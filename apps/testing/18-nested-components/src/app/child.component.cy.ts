...
describe('ChildComponent', () => {
  ...
  describe('When typing nothing and clicking on Validate', () => {
    it('Then show "Title is required" error message and no http request has been sent', () => {
      setup();
  ...
  describe('When typing "Good" and clicking on Validate', () => {
    it('Then show "Title is Good" message, no error message and send a http request to the backend', () => {
      setup();
